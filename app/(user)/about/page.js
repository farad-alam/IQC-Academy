      ...
      <section className={styles.heroSection}>
        <div className={styles.container}>
          <div className={styles.heroGrid}>
            ...
            <FadeIn direction="left" delay={0.2} className={styles.heroImageWrapper}>
              <Image 
      ...
      <section className={styles.missionSection}>
        <div className={styles.container}>
          <StaggerContainer className={styles.missionGrid}>
            <StaggerItem direction="up" className={styles.missionCard}>
            ...
            <StaggerItem direction="up" className={`${styles.missionCard} ${styles.visionCard}`}>
      ...
      <section className={styles.valuesSection}>
        <div className={styles.container}>
          ...
          <StaggerContainer className={styles.valuesGrid}>
            <StaggerItem direction="up" className={styles.valueItem}>
